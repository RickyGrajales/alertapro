    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6">
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                {{-- 🔹 Solo mostrar botón si el usuario tiene rol Admin --}}
                @role('Admin')
                        ...
                        @forelse($organizaciones as $org)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2 flex space-x-2">
                                    <a href="{{ route('organizaciones.show', $org->id) }}"
                                       class="text-blue-600 hover:underline">Ver</a>

                                    @role('Admin')
                                        <a href="{{ route('organizaciones.edit', $org->id) }}"
                                           class="text-yellow-600 hover:underline">Editar</a>

                                        <form action="{{ route('organizaciones.destroy', $org->id) }}"
                                              method="POST"
